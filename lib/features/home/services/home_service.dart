...
// };
// var request = http.MultipartRequest('POST', Uri.parse('https://demo.etcweb.in/api/getAvailableCourses'));
...
//     showSnackbar(
//       context, 'course fetch success');
//       print("   data     ");
//       print(availableCoursesModel.courses?[1].courseDetails?.name);
//       return availableCoursesModel;
//   }else{
//     showSnackbar(
//       context, 'course fetch failed');
//   }
// }
// else {
